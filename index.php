                ...
                <div class="profil_bg">
                    ...
                    <div class="absolute_img">
                       <div class="togger"> 
                        ...
                        <!-- <li style="--i:0;"><a href="#"><ion-icon style="color:white;size: 50px;" name="close-outline"></ion-icon></a> </li> -->
                         <li style="--i:0;"><a href="#"><ion-icon style="color:white;size: 50px;" name="print-outline"></ion-icon></a> </li>
                         <li style="--i:1;"><a href="#"><ion-icon style="color:white;size: 50px;" name="share-social-outline"></ion-icon></a> </li>
                         <!-- <li style="--i:2;"><a href="#"><ion-icon style="color:white;size: 50px;" name="share-social-outline"></ion-icon></a> </li> -->
                    </div>
                </div>
            </section>
...
let absolute_img = document.querySelector('.absolute_img');
togger.onclick = function () {
    absolute_img.classList.toggle('active')
}
      </script>
